# COMS W 4995: Applied Machine Learning
# Deliverable 3
...
# Quick script for generating the dataset used in `AML_Deliverable 3_Group 24.ipynb`. The result is 
# an aggregate dataset consisting of basic 2024 Fortune1000 company financials from Kaggle and a set 
# of metrics (raw EBITDA) pulled from Yahoo! Finance to be used to help determine Market Cap.
